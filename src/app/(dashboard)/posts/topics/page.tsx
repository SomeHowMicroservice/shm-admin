...
import TopicDetailModal from "../components/DetailTopicModal";
...
const TopicPage = () => {
  ...
  const [selectedTopic, setSelectedTopic] = useState<Size | null>(null);
    ...
    <div className="p-4">
      <div className="flex justify-between mb-5">
        <Space>
          ...
          <Popconfirm
            title={`Bạn có chắc muốn xóa ${selectedRowKeys.length} topic này?`}
